...
SPECS: List[ImageSpec] = [
    ImageSpec(
        src="ce-inseamna-cand-visezi-morti-hero.jpg",
        out="visezi-morti-explicatie-inteles-hero.webp",
        role="hero",
        target_width=1600,
        target_height=900,
        alt="Persoană care privește către o fereastră în lumina dimineții, reflectând asupra unui vis cu persoane decedate",
        caption="Visurile cu persoane dragi dispărute aduc adesea dor, teamă și întrebări despre sensul lor emoțional.",
        placement="Imediat după H1, înainte de rezumatul interpretării",
        keywords=["visezi morți", "înțeles spiritual", "interpretare emoțională"],
        priority="1",
    ),
    ImageSpec(
        src="vise-simboluri-flori.jpg",
        out="vise-simboluri-mesaje-subconstient.webp",
        role="inline",
        target_width=1200,
        target_height=675,
        alt="Buchet de flori uscate ținut în mâini, simbolizând transformarea emoțiilor din vis",
        caption="Simbolurile florale indică deseori nevoia de a lăsa lucrurile nerezolvate să se stingă treptat.",
        placement="Secțiunea 'Semnificații spirituale', la mijlocul articolului",
        keywords=["transformare", "mesaj subconștient", "vise simbolice"],
        priority="2",
    ),
    ImageSpec(
        src="vise-discutie-psiholog.jpg",
        out="discutie-psiholog-tristete-vis.webp",
        role="inline",
        target_width=1200,
        target_height=675,
        alt="Ședință de consiliere psihologică pentru procesarea unui vis tulburător",
        caption="Discuția cu un specialist ajută la normalizarea emoțiilor și la găsirea unor ritualuri de despărțire sănătoase.",
        placement="Secțiunea 'Când este util să vorbești cu un specialist'",
        keywords=["consiliere", "procesare emoțională", "vise recurente"],
        priority="3",
    ),
]
